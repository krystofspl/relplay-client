<template>
  <modal v-if="modalVisible" @close="hideModal()">
    <div slot="header">
      ...
      <h2 v-if="modalAction == 'editAlbumTracks'">{{ $t('components.ModalActions.editAlbumTracks') }}</h2>
    ...
    <div slot="actions" style="display: inline">
      ...
      <div v-if="modalAction == 'editAlbumTracks'" style="display: inline">
    ...
    <div slot="body">
      ...
      <edit-album-tracks v-if="modalAction == 'editAlbumTracks'" :album="getAlbum(modalEntities.entityId)"></edit-album-tracks>
...
import EditAlbumTracks from '../misc/EditAlbumTracks.vue'
